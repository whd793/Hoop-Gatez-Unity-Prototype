...
namespace OnefallGames
{
    public class AdManager : MonoBehaviour
    {
        ...
        [SerializeField]
        private int minRewardedCoins = 50;
        [SerializeField]
        private int maxRewardedCoins = 100;
        [SerializeField]
        ...
        IEnumerator ShowAdmobRewardBasedVideo(float delay)
        {
            ...
            if (rewardBasedVideo.IsLoaded())
            {
                Debug.Log("Show rewarded base video");
                rewardBasedVideo.Show();
            }
            else
            {
                Debug.Log("Rewuest rewarded base video");
                RequestAdmobRewardBasedVideo();
            }
#endif
        }
        ...
        {
            if (rewardedVideoAdType == AdType.Admob) //Admob ad
            {
                if (isAdmobRewardedVideoFinished)
                {
